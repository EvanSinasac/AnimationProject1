...
//INFO6045 Animation Project 1
//main.cpp description:
//					The purpose of this project is to implement keyframe animation and showcase it using different
//					interpolation methods.  I decided to make this a very simple animation project that 
//					shows the requirements for the project using wireframe objects to show the 3D of the objects
//					and for the spheres to show the rotations
